...
public class PayablesTests
{
    ...
    public async Task SupplierIdIndicado_EEncontrado_LigaAFactura()
    {
        var fornecedor = new SupplierReference(
            Guid.CreateVersion7(), "Sonangol Distribuidora", "5401234567", null, nameof(SupplierStatus.Active), new SupplierAddress("Rua A", "Luanda", "AO"));
    ...
    {
        var fornecedor = new SupplierReference(
            Guid.CreateVersion7(), "Angoferragens", "5402123456", null, nameof(SupplierStatus.Active), new SupplierAddress("Rua A", "Luanda", "AO"));
