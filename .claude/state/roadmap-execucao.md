...
| 8 | Camadas de composição e portais | **Fechada a 2026-09-04, com uma correcção a 2026-09-16:** o Portal do Colaborador tinha só `/portal/me` — assiduidade, férias, documentos e recibos respondiam 404, e o ecrã pedia-os. Fechado a sério pelo ADR-062, com o perfil `Colaborador` (ADR-061) a chegar na véspera. **Escrever** pelo portal continua fora. Configurações & Administração (ADR-041), Portal do Colaborador (ADR-042), Dashboard Executivo e Portal do Cliente (ADR-043: resumo financeiro + facturas + extracto + pagamento ADR-044 + mensagens ADR-045 + tickets ADR-046) e Analytics & IA (ADR-047: dashboards mais profundos + importação CSV) — todos feitos |
