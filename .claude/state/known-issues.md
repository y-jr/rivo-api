...
- **Módulo:** verificação end-to-end (`scripts/verify-ledger.ps1` caso 45 —
  ...
  58, `scripts/verify-payroll.ps1` caso 21 — era o caso 15 até ao motor de
  IRT/INSS (2026-08-30, +2 casos antes deste) e o Recibo via `documents`, no
  mesmo dia (+5 casos antes deste)) — não se confirmou defeito na aplicação,
